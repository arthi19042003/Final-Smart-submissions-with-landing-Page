      ...
      <>
        {role === 'candidate' && (
          <>
            ...
            <Link to="/profile" className="navbar-link" onClick={closeSidebar}>Profile</Link>
            <Link to="/resume" className="navbar-link" onClick={closeSidebar}>Resume</Link>
            <Link to="/interviews" className="navbar-link" onClick={closeSidebar}>Interviews</Link>
          </>
        )}
